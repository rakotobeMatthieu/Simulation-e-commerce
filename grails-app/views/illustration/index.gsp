...
%{--                            <img class="card-img-top img-responsive" src="../assets/images/cod.jpg" alt="Card image cap">--}%
                            <a href="/illustration/edit/${illustrationList.id}"><asset:image src="${illustrationList.filename}" class="card-img-top" width="200px" height="181px" alt="Card image cap"/></a>
                            <div class="card-body">
                                <h4 class="card-title"><a href="/illustration/edit/${illustrationList.id}">${illustrationList.filename}</a></h4>
                                <p class="card-text"> <a href="/saleAd/edit/${illustrationList.saleAd.id}">${illustrationList.saleAd.title}</a></p>
