            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">Update Illustration</div>
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center title-2">Update Illustration Form</h3>
                                    </div>
                                    <hr>
                                <g:form resource="${this.illustration}" method="PUT">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="col col-md-3">
                                                    <label for="file-input" class=" form-control-label"> File name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="filename" name="filename" placeholder="Enter a filename" value="${illustration.filename}"  class="form-control" required="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col col-md-3">
                                            <label for="select" class=" form-control-label">Select an ads</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <select id="saleAd" name="saleAd" class="form-control" required="">

                                                <g:each in="${grails.SaleAd.list()}" var="saleAdList" name="author" optionKey="id">

                                                    <g:if test="${saleAdList.id == illustration.saleAd.id}">
                                                        <option value="${saleAdList.id}" selected="selected">${saleAdList.title}</option>
                                                    </g:if>
                                                    <g:else>
                                                        <option value="${saleAdList.id}">${saleAdList.title}</option>
                                                    </g:else>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <a href="/illustration/edit/${illustration.id}">
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-warning btn-block">
                                                    <i class="fa fa-upload fa-lg"></i>&nbsp;
                                                    <span id="payment-button-amount">Update Illustration</span>
                                                </button>
                                            </a>
                                        </div>
                                    </div>
